                        ...
                        >
                            ...
                            <div className="flex-1 p-10 flex flex-col justify-between">
                                <div>
                                    <div className="flex justify-between items-start mb-6">
                                        <div className="flex items-center space-x-4">
                                            <div className="text-center">
                                                <div className="text-4xl font-display text-white group-hover:text-secondary transition-colors">{event.day}</div>
                                                <div className="text-[10px] text-white/40 uppercase font-bold tracking-widest">{event.month}</div>
                                            </div>
                                    ...
                                    <h4 className="text-2xl font-bold text-white mb-6 group-hover:text-secondary transition-colors">
                                        {event.title}
                                    </h4>
                                </div>
